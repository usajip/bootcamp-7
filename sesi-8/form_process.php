				...
				<?php else: ?>
					<div class="card">
						<div class="card-body">
							...
							<img src="<?php echo htmlspecialchars($image['tmp_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" alt="Product Image" class="img-fluid mt-3">
						</div>
					</div>
					<a href="index.php" class="btn btn-primary mt-3">Input Another Product</a>
				<?php endif; ?>
			</div>
		</div>
	</div>
